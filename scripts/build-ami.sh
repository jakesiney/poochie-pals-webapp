...
# 0 - Configure AWS CLI
export AWS_ACCESS_KEY_ID=$AWS_CLI_TOKEN
export AWS_SECRET_ACCESS_KEY=$AWS_SECRET_TOKEN
...
scp -o StrictHostKeyChecking=accept-new \
    -i ./keypair \
    -r ./build_instance_id ec2-user@$INSTANCE_IP:/var/poochie-pals
